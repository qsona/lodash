...
;(function() {
  ...
  function runInContext(context) {
     ...
     * // => [1, 3]
     */
    var difference = restParams(function(array, values) {
     ...
     * // => [10, 20]
     */
    var pullAt = restParams(function(array, indexes) {
      array || (array = []);
     ...
     * // => [1, 2, 4]
     */
    var union = restParams(function(arrays) {
     ...
     * // => [3]
     */
    var without = restParams(function(array, values) {
      return (isArray(array) || isArguments(array))
     ...
     * // => ['fred', 'pebbles']
     */
    var at = restParams(function(collection, props) {
      var length = collection ? collection.length : 0;
      if (isLength(length)) {
     ...
     * // => [['1', '2', '3'], ['4', '5', '6']]
     */
    var invoke = restParams(function(collection, methodName, args) {
      var index = -1,
     ...
     * // => 'hi fred!'
     */
    var bind = restParams(function(func, thisArg, partials) {
     ...
     */
    var bindAll = restParams(function(object, methodNames) {
     ...
     * // => 'hiya fred!'
     */
   var bindKey = restParams(function(object, key, partials) {
     ...
     */
    var defer = restParams(function(func, args) {
     ...
     */
    var delay = restParams(function(func, wait, args) {
     ...
     * // => 'hi fred'
     */
    var partial = restParams(function(func, partials) {
     ...
     * // => 'hello fred'
     */
    var partialRight = restParams(function(func, partials) {
     ...
     * // => [3, 6, 9]
     */
    var rearg = restParams(function(func, indexes) {
      return createWrapper(func, REARG_FLAG, null, null, null, baseFlatten(indexes));
    });

    /**
     * Creates a function that invokes `func` with the arguments provided to the
     * created function rolling up arguments beyond the `start` position into an
     * array. The `func` is invoked with the `this` binding of the created function.
     *
     * **Note:** This method is based on ES6 rest parameters. See the
     ...
     * @example
     *
     * var say = _.restParams(function(what, names) {
     *   var result = what + ' ' + (
     *     _.size(names) > 1
     *       ? _.initial(names).join(', ') + ', & ' + _.last(names)
     *       : _.first(names)
     *   );
     * });
     *
     ...
     */
    function restParams(func, start) {
      if (typeof func != 'function') {
        throw new TypeError(FUNC_ERROR_TEXT);
      }
     ...
     * // => { 'user': 'barney', 'age': 36 }
     */
    var defaults = restParams(function(args) {
      var object = args[0];
      if (object == null) {
        return object;
      }
     ...
     * // => { 'user': 'fred' }
     */
    var omit = restParams(function(object, props) {
      if (object == null) {
        return {};
      }
     ...
     * // => { 'user': 'fred' }
     */
    var pick = restParams(function(object, props) {
      if (object == null) {
        return {};
      }
     ...
     * }
     */
    var attempt = restParams(function(func, args) {
      try {
